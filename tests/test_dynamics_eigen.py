...
def test_classify_regime():
    """v5.12 — classify_regime 12 cases: 3 regime + placeholder + 负值 + 边界 + 异常 + near-zero。"""
    ...
    # 3. 平衡 (|k|/|c|=0.5/0.49=1.0204 在 [1/1.1, 1.1]=[0.9091, 1.1] 内)
    ...
    # 6. 边界: |k|/|c|=1.10 → balanced (恰在阈值边界,不超)
